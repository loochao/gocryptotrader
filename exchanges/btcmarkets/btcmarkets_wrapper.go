...
func (b *BTCMarkets) FetchTicker(p pair.CurrencyPair, assetType string) (ticker.Price, error) {
...
func (b *BTCMarkets) FetchOrderbook(p pair.CurrencyPair, assetType string) (orderbook.Base, error) {
