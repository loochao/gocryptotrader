...
func (p *Poloniex) FetchTicker(currencyPair pair.CurrencyPair, assetType string) (ticker.Price, error) {
...
func (p *Poloniex) FetchOrderbook(currencyPair pair.CurrencyPair, assetType string) (orderbook.Base, error) {
