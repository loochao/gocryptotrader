...
func (h *HUOBIHADAX) FetchTicker(p pair.CurrencyPair, assetType string) (ticker.Price, error) {
...
func (h *HUOBIHADAX) FetchOrderbook(p pair.CurrencyPair, assetType string) (orderbook.Base, error) {
